            ...
            <div class="row justify-content-between">
                <div class="col-md-4 col-lg-4 mil-mb-60">
                    ...
                    <div class="mil-muted mil-logo mil-up mil-mb-30">
                        <img src="{{ asset('img/logos/navbarlogodark.png') }}" alt="Logo" width="200" height="auto">
                    </div>

                    <p class="mil-light-soft mil-up mil-mb-30">Baraka – maishiy texnika, elektronika va mebel
                        mahsulotlarini muddatli toʻlov asosida sotuvchi doʻkonlar tarmogʻi. Kompaniya 2014-yilda Qoʻqon
                        shahrida tashkil etilgan. Korxonamiz 10 yildan oshiq muddat mobaynida koʻplab yurtdoshlarimizga
                        halol muddatli toʻlovga mahsulotlar yetkazib berib kelmoqda.</p>
                ...
                <div class="col-md-7 col-lg-6">
                    <div class="row justify-content-end">
                        <div class="col-md-6 col-lg-7">
                            ...
                            <nav class="mil-footer-menu mil-mb-60">
                                <ul>
                                    ...
                                    <li class="mil-up {{ Request::is('about') ? 'mil-active' : '' }}">
                                        <a href="{{ url('/about') }}">Biz haqimizda</a>
                                    </li>
                                    <li class="mil-up {{ Request::is('bizning-jamoa') ? 'mil-active' : '' }}">
                        ...
                        <div class="col-md-6 col-lg-5">
                            ...
                            <nav class="mil-footer-menu mil-mb-60">
                                <ul>
                                    <li class="mil-up {{ Request::is('branches') ? 'mil-active' : '' }}">
                                        <a href="{{ url('/branches') }}">Bizning filiallar</a>
                                    </li>
                                    <li class="mil-up {{ Request::is('jobs') ? 'mil-active' : '' }}">
                                        <a href="{{ url('/jobs') }}">Bo'sh ish o'rinlari</a>
                                    </li>
                                    <li class="mil-up {{ Request::is('application') ? 'mil-active' : '' }}">
            ...
            <div class="row justify-content-between flex-sm-row-reverse">
                <div class="col-md-7 col-lg-6">
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-6 col-lg-6 mil-mb-60">

                            <h6 class="mil-muted mil-up mil-mb-30">Qo'qon shahar</h6>

                            <p class="mil-light-soft mil-up">Charxiy 1-a uy <span class="mil-no-wrap">+998 73 249
                                    2929</span><br>Mo'ljal: Charxiy bozorchasi </p>

                        </div>
                        <div class="col-md-6 col-lg-6 mil-mb-60">

                            <h6 class="mil-muted mil-up mil-mb-30">Toshkent shahar</h6>

                            <p class="mil-light-soft mil-up">A. Temur 61-uy <span class="mil-no-wrap">+998 73 249
                                    2929</span><br>Mo'ljal: Oqsaroy milliy taomlari</p>
                ...
                <div class="col-md-4 col-lg-6 mil-mb-60">
                    ...
                    <div class="mil-vert-between">
                        ...
                        <p class="mil-light-soft mil-up">© Barcha huquqlar himoyalangan 2024 - Baraka Development</p>
                    </div>
